...
constructor TFractal04e05.Create(PaintBox01 : TPaintBox);
begin
  inherited Create;
  fractal(PaintBox01);
...
procedure TFractal04e05.desenhaSol(canvas: Tcanvas; inicioX, inicioY, tamanho: integer; cor: cardinal; delay : Integer);
var
  i: Integer;
...
procedure TFractal04e05.fractal(PaintBox01 : TPaintBox);
var
...
begin
  ...
  desenhaSol(PaintBox01.Canvas, 600, 40, 150, rgb(255, 255, 220), delay); //clYellow


end;

procedure TFractal04e05.pintar(canvas: TCanvas; corInicial: cardinal; tamanho : TCoordenadas);
var
  i, j : Integer;
  corPintar : Cardinal;
